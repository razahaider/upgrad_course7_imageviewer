...
class Profile extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            profile_picture: 'displaypic.png',
            username: null,
    ...
    editCloseEventHandler = () => {
        this.setState({ editOpen: false });
    }

    imageOpenEventHandler = (event) => {
            ...
            <div>
                ...
                <div className="information-section">
                    ...
                    <span style={{marginLeft: "20px"}}>
                        ...
                        <Fab mini variant="round" color="secondary" aria-label="Edit" style={{marginLeft: "20px"}} onClick={this.editEventHandler}>
                            <Icon>edit_icon</Icon>
                        </Fab>
                        </div>
                        <Modal
                            ...
                            onClose={this.editCloseEventHandler}
                ...
                {this.state.filteredData.map(item => (
                    ...
                    <CardMedia
                        ...
                        title=""
                        onClick={this.imageOpenEventHandler}
                    />
                    </GridListTile>
                ))}
                </GridList>}
                ...
                <Modal
                    ...
                    onClose={this.imageCloseEventHandler}
